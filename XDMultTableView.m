...
- (void)tableView:(UITableView *)tableView willDisplayHeaderView:(UIView *)view forSection:(NSInteger)section{
    [self tableView:tableView invoke_willDisplayHeaderView:view forSection:section];
}
...
- (void)tableView:(UITableView *)tableView invoke_willDisplayHeaderView:(UIView *)view forSection:(NSInteger)section {
    if (self.delegate && [self.delegate respondsToSelector:@selector(mTableView:willDisplayHeaderView:forSection:)]) {
        [self.delegate mTableView:self willDisplayHeaderView:view forSection:section];
    }
}
